Rswag::Ui.configure do |c|
  ...
  c.swagger_endpoint '/api/docs/v1/admin_api.json', 'Admin API V1 Docs'
  c.swagger_endpoint '/api/docs/v1/api_v1.json', 'API V1 Docs'
  c.swagger_endpoint '/api/docs/v1/auth_api.json', 'Auth API Docs'
