...
describe "PUT /admin/members/:id", type: :request do
  let(:endpoint) { put admin_member_path(member), params: correct_params, as: :json }
  let(:correct_params) { {
    name: "John Doe"
    } }
  ...
  context "when user is an admin" do
    ...
    context "but the member doesn't exist" do
      before { put admin_member_path(200), params: correct_params, as: :json }
