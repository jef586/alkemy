...
describe "PUT /admin/posts/:id", type: :request do
  let(:endpoint) { put admin_post_path(post), params: correct_params, as: :json }
  let(:correct_params) { {
  ...
  context "when user is an admin" do
    ...
    context "but the post doesn't exist" do
      before { put admin_post_path(200), params: correct_params, as: :json }
